__all__ = ["common_item", "priority", "sum_priorities", "generate_group", "find_group_badge", "sum_badge_priorities"]
...
def sum_badge_priorities(
    ...
    return sum([priority(find_group_badge(group)) for group in generate_group(inputs,sz=sz)])